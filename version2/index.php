...
$grant_funding = [
	["CMU", "Find More Brains", "500"],
        ["CMU", "Robots", "6000"],
        ["CSE", "Find More Brains", "1100"],
        ["GMU", "Find More Brains", "1300"],
        ["GW", "Find More Brains", "1400"],
        ["LSU", "Plant it", "300"],
        ["MCLA", "Find More Brains", "100"],
        ["MCLA", "Robots", "300"],
        ["UA", "Drink More Water", "1000"],
        ["TTU", "Robots", "1000"],
        ["PSU", "Plant it", "1000"],
        ["RIC", "Design it", "100"],
        ["MIT", "Robots", "2200"],
        ["MIT", "Monsters Inc", "1000"],
        ["MIT", "Find More Brains", "1000"],
        ["MIT", "Drink More Water", "1300"],
	["UCLA", "Robots", "800"],
	["BYU", "Find More Brains", "500"],
...
{
    $str = "\n";
    $str.= "<table border='1' id='example1' class='main display compact' width='100%'>\n<thead>\n<tr>\n";
    $str.= "  <td> </td>\n";
    foreach($program_names as $k => $program) {
        $str.= "  <td> $k </td>\n";
    }
...
function displayReport($data)
{
    ...
    if ($total) $header .= tableBuilder("Total", $program_names, $data);
